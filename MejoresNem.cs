...
{
    public class MejoresNem : Estadistica
    {
        public MejoresNem() : base("Las 10 comunas con mejor promedio NEM")
        {
        }
        ...
        public override void MostrarEstadistica(List<Fila> filas)
        {
            ...
            var promediosPorComuna =
                            ...
                            select new PromedioComuna(datosComuna.Key, promedio.CalcularPromedioNem(datosComuna.ToList()));
            ...
            {
                Console.WriteLine($"({i + 1}): {promediosOrdenados[i].comuna} - NEM: {promediosOrdenados[i].promedio}");
            }
        }
    }
}
